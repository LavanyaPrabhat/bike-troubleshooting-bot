...
- **Multilingual support** — questions in Hindi, Kannada, Tamil, Telugu, and other Indic languages are detected and answered in the same language via Sarvam-M
...
Hybrid retrieval (semantic search + BM25, fused via Reciprocal Rank Fusion) feeds a GPT-4o reranker that selects the top five manual passages; GPT-4o generates English answers while Sarvam-M handles Indic-language responses. See `decisions-log.md` for full architectural decisions and trade-off analysis.
...
| Component | Role |
|---|---|
| [OpenAI GPT-4o](https://openai.com) | Query rewriting, re-ranking, English answer generation, image description |
...
| [Sarvam Saaras V3](https://www.sarvam.ai) | Multilingual ASR — voice transcription |
| [Sarvam-M](https://www.sarvam.ai) | Indic-language answer generation |
